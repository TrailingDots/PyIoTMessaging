#!/usr/bin/env python
"""
This code starts testing multiple tasks
as integration testing.

It is not finished - yet.

It provides an example of how to perform
integration testing using log_client and
log_server.
"""
#
# Integration test suite for log_server.py and log_client.py
#
